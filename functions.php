<?php
/**
 * Two-Four functions and definitions
 *
...
if ( ! function_exists( 'two_four_setup' ) ) :
	...
	function two_four_setup() {
		 ...
		 * If you're building a theme based on Two-Four, use a find and replace
		 * to change 'two-four' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'two-four', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'two_four_custom_background_args', array(
...
add_action( 'after_setup_theme', 'two_four_setup' );
 ...
 */
function two_four_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'two_four_content_width', 640 );
}
add_action( 'after_setup_theme', 'two_four_content_width', 0 );
 ...
 */
function two_four_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'two-four' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'two-four' ),
...
add_action( 'widgets_init', 'two_four_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'two_four_scripts' );
